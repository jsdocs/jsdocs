...
Package.prototype.getProvider = function () {
  return pkg.params.provider
}
...
Package.prototype.update = function (key, value) {
  this.data[key] = value
}

Package.prototype.queue = function (cb) {
  this.data.queued = 1
  this.save(cb)
}

Package.prototype.isQueued = function (cb) {
  this.fetch(err => cb(null, +this.data.queued === 1))
}
